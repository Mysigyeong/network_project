...
EXAMPLE_DIRECTORIES = ['tcp', 'stats', 'tutorial', 'socket', 'udp-client-server', 'naming', 'wireless', 'error-model', 'realtime', 'matrix-topology', 'ipv6', 'udp', 'routing', 'traffic-control', 'energy']
